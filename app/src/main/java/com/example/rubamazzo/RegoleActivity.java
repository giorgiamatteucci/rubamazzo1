...
public class RegoleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvRegole.append("Nel caso in cui fosse presente almeno una carta dello stesso valore nel tavolo allora basterà selezionare prima la propria carta e poi quella sul tavolo, a questo punto il primo giocatore ha già iniziato a creare il proprio mazzo. \n");
        tvRegole.append("Qualora un altro giocatore, durante il proprio turno, avesse in mano una carta dello stesso valore di quella in cima al mazzo delle carte prese da un altro, può rubare il mazzo e metterlo di fianco a sé.\n");
        ...
        tvRegole.append("La partita finisce quando non ci sono più carte da distribuire e le carte rimanenti sul tavolo vengono prese dall'ultimo giocatore che ha preso una carta dal tavolo oppure rubato il mazzo altrui.");
